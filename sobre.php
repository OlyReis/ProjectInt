...
<body>
  ...
  <div class="container">
   <main class="col- col-12 col-md-9 col-xl-8 py-md-3 pl-md-5 bd-content" role="main">
    <h2 id="SD">Sobre o Site</h2><br>
    <p>O site foi criado para expandir o mercado do Modas Z para diversas regiões, levando produtos com ótimos preços e de alta qualidade pertecentes a Marca Z, altamente prestigiada no mercado. Sempre pensando em um bom atendimento ao cliente.</p>  
    <h2>Sobre os Desenvolvedores do Site</h2><br>
    <p>Site criado pela WebSoft.<br>Clique para saber mais:</p>
    <button type="button" class="btn" style="background-color: red;"><a class="text-light font-weight-bold" target="_blank" href="empresa.php
      ">Visitar</a></button>
    </main>
  </div>
