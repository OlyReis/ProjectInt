      ...
      <form class="needs-validation m-4" novalidate>
        <div class="form-row mb-3 mt-3">
          <div class="col">
            ...
            <input type="text" class="form-control input rounded-0" id="NomeProduto" placeholder="Digite um novo Nome para o Produto" name="nomeProduto" onKeyPress="if(this.value.length==111) return false;" value="Tênis" required>
          ...
          <div class="col">
            ...
            <input type="text" class="form-control input rounded-0" onkeydown="javascript: return event.keyCode == 69 ? false : true" onKeyPress="if(this.value.length==4) return false;"  placeholder="*Digite um novo Ano de Lançamento do Produto" name="lancamentoProduto" id="lancamentoProduto" pattern="([0-9]{4})" value="2019" required>
            <div class="invalid-feedback">
        ...
        <div class="form-row mb-3 mt-3">
          <div class="col">
            ...
            <input type="text" class="form-control input rounded-0" id="DescricaoProdutoMenu" onKeyPress="if(this.value.length==310) return false;" placeholder="Digite uma nova Descrição do Produto" name="descricaoProdutoMenu" value="Perfeito para diversas ocasiões" required>
            <div class="invalid-feedback">
        ...
        <div class="form-row mb-3 mt-3">
          <div class="col">
            ...
            <input type="text" class="form-control input rounded-0 precoProduto" id="precoProduto" placeholder="Digite um novo Preço do Produto" name="precoProduto" id="precoProduto" value="R$ 68,90" required>
            <div class="invalid-feedback">
          ...
          <div class="col mt-0">
            ...
            <input type="number" class="form-control input rounded-0 mt-0" id="estoqueProduto" onkeydown="javascript: return event.keyCode == 69 ? false : true" placeholder="Digite um novo Estoque do Produto" name="precoProduto" value="5" required>
            <div class="invalid-feedback">
        ...
        <div class="form-row mb-3 mt-3">
          <div class="col">
            ...
            <input type="number" name="numTamanhos" class="form-control input rounded-0 mt-0" id="numTamanhos" placeholder="Digite uma nova Quantidade de Tamanhos do Produto" onkeydown="javascript: return event.keyCode == 69 ? false : true" onKeyPress="if (this.value.length >= 2) return false;" value="7" required>
          </div>
          <div class="col">
            <label form="labelTamanhosProduto" class="mb-0">Tamanhos (Separados por vírgula)</label>
            <input type="text" name="tamanhosProduto" class="form-control input rounded-0 mt-0" id="tamanhosProduto" placeholder="Digite novos Tamanhos do Produto" onKeyPress="if (this.value.length >= 29) return false;" value="38,39,40,41,42,43,44" data-mask="00,00,00,00,00,00,00" required>
          </div>
        </div>
