...
$dad = array($_GET['nome'], $_GET['sobrenome'],$_GET['data_nascimento'],$_GET['sexo'],$_GET['cpf'],$_GET['cep'],$_GET['telefone'],$_GET['endereco'],$_GET['nun_endereco'],$_GET['complemento'],$_GET['cidade'],$_GET['bairro'],$_GET['estado'],$_GET['email'],$_GET['senha']);
