...
<body>
  <nav class="navbar navbar-expand-lg navbar-dark navbar-sm fixed-top">
    <a class="navbar-brand" title="Menu"  href="index.html">
      <img src="Img/Logo.png" width="30" height="30" alt="">
    </a>
    <a class="navbar-brand" title="Menu" href="index.html">Modas Z</a>
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav mr-auto">
        ...
        <li class="nav-item">
          <a class="nav-link " href="contato.html" tabindex="-1">Contato</a>
        </li>
        <li class="nav-item">
          <a class="nav-link " href="sobre.html" tabindex="-2">Sobre</a>
        </li>
      </ul>
      <a href="carrinho.html" class="mr-3"><svg width="2em" height="2em" viewBox="0 0 16 16" class="bi bi-cart2" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
      ...
      <button type="button" class="btn btn-dark"><a href="login.html">Login<svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-person-square ml-2" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
  ...
  <div class="container col-12 divlogin rounded border border-primary mb-5"> 
    ...
    <form class="needs-validation m-4" novalidate>
      ...
      <a class="btn btn-sm btn-rounded text-primary font-weight-bold text-center w-100" id="criarConta" style="height: 40px; font-size: 16px; border:none;" href="cadastro.html" role="button">Criar conta</a>
    </form>
</div>
  ...
  <div class="row">
    ...
    <div class="col- col-6 col-md">
      ...
      <ul class="list-unstyled text-small">
        <li><a href="sobre.html#SD">Informações da Empresa</a></li>
        <li><a href="sobre.html">Informações dos Desenvolvedores do Site</a></li>
      </ul>
    </div>
    <div class="col- col-6 col-md">
      <h5>Contato</h5>
      <ul class="list-unstyled text-small">
        <li><a href="contato.html">E-mail</a></li>
        <li><a href="contato.html#SD">WhatsApp</a></li>
      </ul>
    </div>
    <div class="col- col-6 col-md">
      <h5>Redes Sociais</h5>
